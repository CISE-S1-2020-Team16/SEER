...
class ArticlesUpdate extends Component {
    ...
    componentDidMount = async () => {
        ...
        this.setState({
            ...
            journal: article.data.data.journal,
            year: article.data.data.year,
            volume: article.data.data.volume,
            number: article.data.data.number,
            pages: article.data.data.pages,
            month: article.data.data.month,
        })
    }
